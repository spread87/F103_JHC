...
*************************************************/
static void PanelButtonIdentity(uint8_t button)//�޸����������ʶ�𳤰�
{
  uint32_t temp;

  ButtonFlagOld.all = ButtonFlag.all; //���ܵ�
  ButtonFlag.all = ~button; //���ܵ�
