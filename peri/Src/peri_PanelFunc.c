...
int32_t PanelButtonUp(int32_t Data,int32_t Max,uint8_t Dec_Hex,int32_t twinkle)//2010628 mxj
{
	...
	if(ButtonUp.flg.bit.DI_OUT_F)
	{
		...
		case 8:
			...
			break;
		case 9:
			Data += (Data_Add_Mpy*Data_Add_Mpy*Data_Add_Mpy*Data_Add_Mpy*Data_Add_Mpy*Data_Add_Mpy*Data_Add_Mpy*Data_Add_Mpy);
			if(Data > Max)
				Data = Max;
			break;
		case 10:
			Data += (Data_Add_Mpy*Data_Add_Mpy*Data_Add_Mpy*Data_Add_Mpy*Data_Add_Mpy*Data_Add_Mpy*Data_Add_Mpy*Data_Add_Mpy*Data_Add_Mpy);
			if(Data > Max)
				Data = Max;
			break;
		default:
