...
extern const FuncCodeSingleF20 FC_InitF20;
extern const FuncCodeSingleF20 FC_MinF20;
extern const FuncCodeSingleF20 FC_MaxF20;
extern const FuncCodeSingleF20 FC_AttF20;
...
void FuncCodeInit(void)
{
  ...
  FuncCode_Handle.Init.F10 = FC_InitF10;
  FuncCode_Handle.Min.F10 = FC_MinF10;
  FuncCode_Handle.Max.F10 = FC_MaxF10;
  FuncCode_Handle.Att.F10 = FC_AttF10;

  FuncCode_Handle.Init.F20 = FC_InitF20;
  FuncCode_Handle.Min.F20 = FC_MinF20;
  FuncCode_Handle.Max.F20 = FC_MaxF20;
  FuncCode_Handle.Att.F20 = FC_AttF20;
...
uint16_t FuncCodeChange(uint16_t Fcode, uint32_t value, FuncCode *FC_Handle, uint8_t FcodeChangeAtt)
{
  ...
  case 10:			//F10xx
    ...
    else
    {
      ...
      FC_Att = *(&FC_Handle->Att.F10.F1000 + FC_Number);
      if ((FC_Att & 0x0018) == 0)
      {
        *(&FC_Handle->Ram.F10.F1000 + FC_Number) = value;
        *(&FC_Handle->E2prom.F10.F1000 + FC_Number) = value;
        if (FcodeChangeAtt)
          *(&FC_Handle->Att.F10.F1000 + FC_Number) |= 0x0100;
        FC_Result = FCODE_CHANGE_OK;
      }
      else if ((FC_Att & 0x0018) == 0x0008)
      {
  ...
  case 20:			//F20xx
    ...
    {
      //mxj=============================20160824=======
      FC_Att = *(&FC_Handle->Att.F20.F2000 + FC_Number);
      if ((FC_Att & 0x0018) == 0)
      {
        *(&FC_Handle->Ram.F20.F2000 + FC_Number) = value;
        *(&FC_Handle->E2prom.F20.F2000 + FC_Number) = value;
        if (FcodeChangeAtt)
          *(&FC_Handle->Att.F20.F2000 + FC_Number) |= 0x0100;
        FC_Result = FCODE_CHANGE_OK;
      }
      else if ((FC_Att & 0x0018) == 0x0008)
      {
...
uint32_t FuncCodeRead(uint16_t Fcode)
{
  ...
  case 10:
    FC_Value = *(&FuncCode_Handle.E2prom.F10.F1000 + FC_Number);

    break;
  case 20:
    FC_Value = *(&FuncCode_Handle.E2prom.F20.F2000 + FC_Number);
...
uint32_t FuncCodeAttRead(uint16_t Fcode)
{
  ...
  case 10:
    FC_Att = *(&FuncCode_Handle.Att.F10.F1000 + FC_Number);

    break;
  case 20:
    FC_Att = *(&FuncCode_Handle.Att.F20.F2000 + FC_Number);
...
void FuncCodeChangeAttClear(uint16_t Fcode)
{
  ...
  case 10:
    *(&FuncCode_Handle.Att.F10.F1000 + FC_Number) &= 0xFFFFFEFF;
    break;

  case 20:
    *(&FuncCode_Handle.Att.F20.F2000 + FC_Number) &= 0xFFFFFEFF;
    break;
...
void FuncCodePanelRead(PANELFCODE *p)
{
  ...
  case 00:
    ...
    break;
  case 10:
    p->Value = *(&FuncCode_Handle.E2prom.F10.F1000 + FC_Number);
    p->Max = *(&FuncCode_Handle.Max.F10.F1000 + FC_Number);
    p->Min = *(&FuncCode_Handle.Min.F10.F1000 + FC_Number);
    p->Att = *(&FuncCode_Handle.Att.F10.F1000 + FC_Number);
    break;
  case 20:
    p->Value = *(&FuncCode_Handle.E2prom.F20.F2000 + FC_Number);
    p->Max = *(&FuncCode_Handle.Max.F20.F2000 + FC_Number);
    p->Min = *(&FuncCode_Handle.Min.F20.F2000 + FC_Number);
    p->Att = *(&FuncCode_Handle.Att.F20.F2000 + FC_Number);
    break;
  case 50:
...
uint32_t FuncCodeOnlyReadValue(PANELFCODE *p)
{
  ...
  case 00:
    ...
    break;
  case 10:
    FcodeValue = *(&FuncCode_Handle.Ram.F10.F1000 + FC_Number);
    break;
  case 20:
    FcodeValue = *(&FuncCode_Handle.Ram.F20.F2000 + FC_Number);
    break;
  case 50:
...
uint8_t FuncCodeReadDetect(uint16_t Fcode, int32_t value)
{
  ...
  case 00:
    ...
    break;
  case 10:
    Min = *(&FuncCode_Handle.Min.F10.F1000 + FC_Number);
    Max = *(&FuncCode_Handle.Max.F10.F1000 + FC_Number);
    if (((int32_t) value >= Min) && ((int32_t) value <= Max))
      FC_Result = 0;
    else
      FC_Result = 1;
    break;
  case 20:
    Min = *(&FuncCode_Handle.Min.F20.F2000 + FC_Number);
    Max = *(&FuncCode_Handle.Max.F20.F2000 + FC_Number);
    if (((int32_t) value >= Min) && ((int32_t) value <= Max))
      FC_Result = 0;
    else
      FC_Result = 1;
