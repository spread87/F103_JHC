...
void MonitorParaHandle(void)
{
	...
	FuncCode_Handle.Ram.FA0.FA001 = g_Vrms_Cmd;//0.1V�趨��ѹ   MonParaVeloCMDCalc();
	FuncCode_Handle.Ram.FA0.FA002 = g_VrmsCalc;//0.1Vʵ�������ѹ();
	//FuncCode_Handle.Ram.FA0.FA003 = g_Irms_Cmd;//0.1A�趨����   MonParaIrmsCalc();
	FuncCode_Handle.Ram.FA0.FA003 = g_Irms_Cmd_A;//0.1A�趨����   MonParaIrmsCalc();;
	FuncCode_Handle.Ram.FA0.FA004 = g_IrmsCalc;//0.1Aʵ���������   MonParaAvgLoadRateCalc();
	FuncCode_Handle.Ram.FA0.FA005 = g_PrmsCalc/1000;//0.1kWʵ���������    MonParaVrmsCalc();
	...
	//FuncCode_Handle.Ram.FA0.FA009 = (int32_t)(g_EncPulAllCount - g_SHome_Finish_g_EncPulAllCount);//20170911 mxj
	...
	//FuncCode_Handle.Ram.FA0.FA012 = g_DIsts;
	FuncCode_Handle.Ram.FA0.FA012 = g_DIAddVir_sts;//20190922
	//FuncCode_Handle.Ram.FA0.FA013 = g_DOsts ^ 0x003F;//CYL
	FuncCode_Handle.Ram.FA0.FA013 = g_DOsts;//20190328
	//FuncCode_Handle.Ram.FA0.FA014 = MonParaToutCalc();
	FuncCode_Handle.Ram.FA0.FA015 = 0;
	//FuncCode_Handle.Ram.FA0.FA016 = MonParaAI1Calc();//ExAI.AI1Q24
	//FuncCode_Handle.Ram.FA0.FA017 = MonParaAI2Calc();//ExAI.AI2Q24
	//FuncCode_Handle.Ram.FA0.FA018 = MonParaAI3Calc();//ExAI.AI3Q24
	FuncCode_Handle.Ram.FA0.FA016 = MonParaAI1ADCalc(g_AI1FilQ24);//AI1 AI�����ѹֵ 20190704
	...
	//FuncCode_Handle.Ram.FA0.FA020 = ComCtrlFlg.all ;
	...
	//FuncCode_Handle.Ram.FA0.FA027 = g_ComDO;//800C    ���ڳ���״̬����
	FuncCode_Handle.Ram.FA0.FA028 = SeriEncoder.Angle;
	//FuncCode_Handle.Ram.FA0.FA029 =SeriEncoder._1RevPuls;
	...
	FuncCode_Handle.Ram.FA0.FA033 = ComCtrlFlg.all;//����������
	FuncCode_Handle.Ram.FA0.FA034 = CoreStatusFlag.all;//״̬��


	//FuncCode_Handle.Ram.FA0.FA040 = CCU41_CC40->TIMER;//�ⲿ��������Ĵ���
	FuncCode_Handle.Ram.FA0.FA040 = g_PulInPosition;//��������Ƶ�ʣ����ӳ��ֱȺ󣬵�λkHz
	FuncCode_Handle.Ram.FA0.FA041 = (g_EncoderUVWQ24>>22)*10000 + CCU40_CC40->TIMER;//Encoder cnt
	//FuncCode_Handle.Ram.FA0.FA042 =
	//FuncCode_Handle.Ram.FA0.FA043 = g_EncoderZcheck;//����ͨѶ�������
	//FuncCode_Handle.Ram.FA0.FA044 = g_index_counter;//����ͨѶ��ַ��ʾ
	//FuncCode_Handle.Ram.FA0.FA044 = (FuncCode_Handle.Ram.FA0.FA044 &0x0FFFFF)|(((int32_t)MX_GPIO_ReadPin(IO004_Handle28)<<20)&0x0100000);//����λ��ʾREDE״̬
	//IO004_SetOutputValue(IO004_Handle28,1);
	//((int32_t)MX_GPIO_ReadPin(IO004_Handle28)<<20)
	FuncCode_Handle.Ram.FA0.FA045=MX_GPIO_ReadPin(IO004_Handle26) + g_RXDL*1000 + g_TXDataLength *10;//��λ��ʾREDE״̬
	//FuncCode_Handle.Ram.FA0.FA045=MX_GPIO_ReadPin(IO004_Handle28);//��ʾREDE״̬
	//g_canview15 = ((int32_t)MX_GPIO_ReadPin(IO004_Handle28)<<21)*(g_TXDataLength+1) + ((int32_t)g_RXDataLength<<21);//test
	...
	//FuncCode_Handle.Ram.FA0.FA049 = MonParaAI1ADCalc(g_AI1AD);//AI1
	//FuncCode_Handle.Ram.FA0.FA050 = MonParaAI1ADCalc(g_AI2AD);//AI2
	//FuncCode_Handle.Ram.FA0.FA049 = MonParaAI1ADCalc(g_AI1FilQ24);//AI1  20190704
	//FuncCode_Handle.Ram.FA0.FA050 = MonParaAI1ADCalc(g_AI2FilQ24);//AI2
	FuncCode_Handle.Ram.FA0.FA049 = MonParaAI1Calc();//ExAI.AI1Q24 �������߱任���0.1%  20190704
	FuncCode_Handle.Ram.FA0.FA050 = MonParaAI2Calc();//ExAI.AI2Q24
	//FuncCode_Handle.Ram.FA0.FA051 = MonParaAI3Calc();//ExAI.AI3Q24
...
int32_t MonParaVeloCMDCalc(void)
{
	...
	//AvgVeloCMD = (int64_t)AvgVeloCMDQ24 * MotorPara.RatedVel;
...
int32_t MonParaIrmsCalc(void)
{
	...
	{
		//AvgIrms = (int32_t)((Sum * 10  * DriverPara.RatedCur) >> 31);
	...
	//AvgIrms = (int64_t)AvgIrmsQ24 * DriverPara.RatedCur;
	//return (int32_t)(AvgIrms >> 24);
...
void TerminalIOSts(void)
{
	...
	DOSts = MX_GPIO_ReadPin(IO004_Handle18) | (MX_GPIO_ReadPin(IO004_Handle19) << 1) | (MX_GPIO_ReadPin(IO004_Handle20) << 2)  \
			| (MX_GPIO_ReadPin(IO004_Handle21) << 3) | (MX_GPIO_ReadPin(IO004_Handle22) << 4) | (MX_GPIO_ReadPin(IO004_Handle23) << 5);
