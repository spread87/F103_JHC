...
int16_t WaveA[1000]={0};
int16_t WaveB[1000]={0};
int16_t WaveC[1000]={0};
int16_t WaveD[1000]={0};
//int16_t WaveE[1000]={0};
...
void Wave_dis(void)//1ms�������  0x22����ָ����
{
	  ...
	  if((CanTransmitData.tempCanMonEn > 0) && (FuncCode_Handle.Ram.F60.F6025 != 0)) //��λ����ع���
	  {
		...
		else
		{
			...
			if((CoreStatusFlag.bit.WAVE_DATA_F==NG)&&(CoreStatusFlag.bit.WAVE_DATA_S)) //״̬��3��bit0�������ȡ��ɣ�������Ҫ�����������ݣ��Ϳ������¿�ʼ��������
			{
...
void Wave13_dis(void)//Modbus13ָ������������  0x13����ָ����
{
	  ...
	  //Wave13[4] += 16777;//0.001
	  //Wave13[4] += 1;//0.001

	 // Wave13[3] = (Timer1msCount * 16777)>>10;//0.001/ms,
	 // Wave13[4] += 1;//0.001
}
